...
var styles = {
  ...
  controls: { flex: "none", display: "flex", alignItems: "center" },
...
function VisionPluginsTab(props) {
  const { t, useEnabled, useSaving, onToggle } = props;
  ...
  const disabledStyle = saving ? { ...styles.toggle, opacity: 0.5, cursor: "default" } : styles.toggle;
  return /* @__PURE__ */ React.createElement("div", { style: styles.tab }, /* @__PURE__ */ React.createElement("div", { style: styles.card }, /* @__PURE__ */ React.createElement("div", { style: styles.cardBody }, /* @__PURE__ */ React.createElement("div", { style: styles.cardInfo }, /* @__PURE__ */ React.createElement("h3", { style: styles.cardTitle }, t("tab.label")), /* @__PURE__ */ React.createElement("p", { style: styles.cardDesc }, t("tab.description"))), /* @__PURE__ */ React.createElement("div", { style: styles.controls }, /* @__PURE__ */ React.createElement("label", { style: disabledStyle }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "checkbox",
  ...
  ), /* @__PURE__ */ React.createElement("span", { style: trackStyle }, /* @__PURE__ */ React.createElement("span", { style: thumbStyle })))))));
}
...
function VisionModelsSection(props) {
  ...
  if (state.status !== "ready") {
    return /* @__PURE__ */ React.createElement("div", { style: s.section }, /* @__PURE__ */ React.createElement("p", { style: s.hint }, t(state.status === "loading" ? "loading" : "unavailable")));
  }
  ...
  return /* @__PURE__ */ React.createElement("div", { style: s.section }, /* @__PURE__ */ React.createElement("h2", { style: s.heading }, t("section.title")), /* @__PURE__ */ React.createElement("p", { style: s.intro }, t("section.description")), /* @__PURE__ */ React.createElement("div", { style: s.toggleRow }, /* @__PURE__ */ React.createElement("div", { style: s.toggleInfo }, /* @__PURE__ */ React.createElement("span", { style: s.toggleLabel }, t("enabled.label")), /* @__PURE__ */ React.createElement("span", { style: s.toggleDesc }, t("enabled.description"))), /* @__PURE__ */ React.createElement("label", { style: s.toggle }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "checkbox",
      style: s.toggleInput,
  ...
  ), /* @__PURE__ */ React.createElement("span", { style: trackSt }, /* @__PURE__ */ React.createElement("span", { style: thumbSt })))), /* @__PURE__ */ React.createElement("div", { style: s.field }, /* @__PURE__ */ React.createElement("label", { style: s.label, htmlFor: `${fieldId}-bu` }, t("model.baseUrl")), /* @__PURE__ */ React.createElement(
    "input",
    {
      id: `${fieldId}-bu`,
      style: inputEnabled,
  ...
  ), /* @__PURE__ */ React.createElement("p", { style: s.hint }, t("model.baseUrl.description"))), /* @__PURE__ */ React.createElement("div", { style: s.field }, /* @__PURE__ */ React.createElement("label", { style: s.label, htmlFor: `${fieldId}-mi` }, t("model.modelId")), /* @__PURE__ */ React.createElement(
    "input",
    {
      id: `${fieldId}-mi`,
      style: inputEnabled,
  ...
  ), /* @__PURE__ */ React.createElement("p", { style: s.hint }, t("model.modelId.description"))), /* @__PURE__ */ React.createElement("div", { style: s.field }, /* @__PURE__ */ React.createElement("label", { style: s.label, htmlFor: `${fieldId}-ake` }, t("model.apiKeyEnv")), /* @__PURE__ */ React.createElement(
    "input",
    {
      id: `${fieldId}-ake`,
      style: inputEnabled,
  ...
  ), /* @__PURE__ */ React.createElement("p", { style: s.hint }, t("model.apiKeyEnv.description"))), /* @__PURE__ */ React.createElement("div", { style: s.field }, /* @__PURE__ */ React.createElement("label", { style: s.label, htmlFor: `${fieldId}-ak` }, t("model.apiKey")), /* @__PURE__ */ React.createElement(
    "input",
    {
      id: `${fieldId}-ak`,
      style: inputEnabled,
  ...
  ), /* @__PURE__ */ React.createElement("p", { style: s.hint }, t("model.apiKey.description"))), /* @__PURE__ */ React.createElement("div", { style: s.footer }, state.failed ? /* @__PURE__ */ React.createElement("p", { style: s.failed, role: "status" }, t("saveFailed")) : null, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
...
function apply(ctx) {
  ...
  const onToggle = () => {
    ...
    failed = false;
    publish();
    scope.set("enabled", !current).then(() => scope.load()).catch(() => {
      failed = true;
    }).finally(() => {
      saving = false;
      publish();
